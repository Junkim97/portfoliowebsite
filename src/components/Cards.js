      ...
      <div className="cards__container">
        <div className="cards__wrapper">
          ...
          <ul className="cards__items">
            ...
            <CardItem src={img4} text="Experience football on top of the Himilayan mountains" label='Adventure' path='/products'/>

            <CardItem src={img8} text="Ride through the Sahara desert on a guided camel tour" label='Adrenaline' path='/sign-up'/>
          </ul>
        </div>
      </div>
